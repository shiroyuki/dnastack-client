#### Class `dnastack.configuration.Authentication(aws: dnastack.configuration.AwsAuthentication, oauth2: dnastack.configuration.OAuth2Authentication)`
Authentication Information
##### Properties
###### `aws: Union[dnastack.configuration.AwsAuthentication, NoneType]`

###### `oauth2: Union[dnastack.configuration.OAuth2Authentication, NoneType]`
