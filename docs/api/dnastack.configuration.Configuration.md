#### Class `dnastack.configuration.Configuration(version: int= 3, defaults: Dict[str, str], endpoints: List[dnastack.configuration.ServiceEndpoint])`
Configuration (v3)
##### Properties
###### `version: int`
...
###### `endpoints: List[dnastack.configuration.ServiceEndpoint]`
